defmodule RandomWordService do
  ...
  @parts_of_speech ["adjective", "adverb", "noun", "verb", :adjective, :adverb, :noun, :verb] 
  @name __MODULE__
  ...
  def get_random_word(starts_with: _letter, part_of_speech: part_of_speech)
    when part_of_speech not in @parts_of_speech do
  ...
  defp atomize_part_of_speech(part_of_speech) do
